...
public class TierOneTests {
  ...
  // implement the constructor in Tile so that it sets the next and prev links to
  // this
  @Test
  public void tileConstructionTest_1() {
    // implement the constructor in Tile so that it sets the next and prev links
    // correctly
  ...
  public void tileConstructionTest_3() {
    ...
    // the list should look like this // (3) <- 1 <-> 2 <-> 3 -> (1)
  ...
  @Test
  public void tileConstructionTest_4() { // implement the constructor in
    /* Tile so that it sets the next and prev links correctly */
    DummyTile sut1 = new DummyTile();
    DummyTile sut2 = new DummyTile(sut1);
  ...
  public void tileConstructiontest_5() {
    ...
    for (int i = 0; i < nodeCount; i++) {
      ...
      assertEquals("start.prev does not link to the last tile after adding tile no: " + i, tiles.get(tiles.size() - 1),
          start.getPrev());
